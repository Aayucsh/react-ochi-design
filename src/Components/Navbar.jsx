...
function Navbar() {
  ...
  return (
    <div className='fixed z-[100] backdrop-blur-sm w-full px-5 md:px-12 py-5 font-["Neue_Montreal"]'>
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-5 lg:gap-10">
          {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((items, index) => (
            <a key={index} className={`text-sm lg:text-md underline-animation cursor-pointer font-regular capitalize ${
              index === 4 && "lg:ml-32 xl:ml-64"
            }`}>
              {items}
            </a>
          ))}
        ...
        <button 
          ...
          className="md:hidden w-8 h-8 flex flex-col justify-center items-center gap-1.5 relative"
        >
          <span className={`w-6 h-0.5 bg-black transition-all duration-300 ease-in-out ${
      ...
      <div className={`md:hidden absolute top-full left-0 w-full bg-white/90 backdrop-blur-sm transform transition-all duration-300 ease-in-out ${
        ...
        <div className="flex flex-col items-center py-5 gap-4">
          {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((items, index) => (
            <a 
              ...
              className="text-md cursor-pointer font-regular capitalize hover:text-gray-600 transition-colors duration-300"
            >
              {items}
            </a>
          ))}
