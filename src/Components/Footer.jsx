...
function Footer() {
  return (
    <div className='w-full flex flex-col lg:flex-row min-h-screen pb-5 bg-[#F1F1F1] px-4 lg:px-0 relative'>
      {/* Left Side */}
      <div className='w-full lg:w-[41vw] h-full '>
        <h1 className='text-5xl md:text-7xl lg:text-9xl uppercase leading-none lg:leading-[100px] pt-10 lg:pt-24 lg:px-16'>
          eye-<br/>opening
        </h1>
        <div className="logo absolute bottom-10 right-5 lg:left-16 lg:bottom-10 z-[9]">
      ...
      <div className='w-full lg:w-1/2'>
        <h1 className='text-5xl md:text-7xl lg:text-9xl uppercase  lg:pt-24'>presentations</h1>
        <div className='flex flex-col md:flex-row gap-8 md:gap-0'>
          
          <div className='w-full md:w-1/2 flex flex-col pt-8 space-y-2'>
            <a className='font-semibold'>S:</a>
            <a className='hover:underline cursor-pointer'>Instagram</a>
            <a className='hover:underline cursor-pointer'>Behance</a>
            <a className='hover:underline cursor-pointer'>Facebook</a>
            <a className='hover:underline cursor-pointer'>LinkedIn</a>
            
            <a className='font-semibold pt-10'>L:</a>
            <a className='hover:underline cursor-pointer'>202-1965 W 4th Ave</a>
            <a className='hover:underline cursor-pointer'>Vancouver, Canada</a>
            <a className='hover:underline cursor-pointer'>30 Chukarina St</a>
            <a className='hover:underline cursor-pointer'>Lviv, Ukraine</a>
            
            <a className='font-semibold pt-10'>E:</a>
            <a className='hover:underline cursor-pointer'>hello@ochi.design</a>
          </div>

          <div className='w-full md:w-1/2 flex flex-col lg:pt-8 md:pt-48 md:pl-40 space-y-2'>
            <a className='font-semibold'>M:</a>
            <a className='hover:underline cursor-pointer'>Home</a>
            <a className='hover:underline cursor-pointer'>Services</a>
            <a className='hover:underline cursor-pointer'>Our Work</a>
            <a className='hover:underline cursor-pointer'>About Us</a>
            <a className='hover:underline cursor-pointer'>Insights</a>
