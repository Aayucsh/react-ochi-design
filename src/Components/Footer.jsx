...
function Footer() {
  return (
    <div className='w-full flex h-screen bg-[#F1F1F1]'>
      <div className='w-1/2 h-full relative'>
      <h1 className='text-9xl uppercase leading-[100px] px-16 pt-24'>eye-<br/>opening</h1>
      <div className="logo absolute left-16 bottom-10 z-[9]">
      ...
      <div className='w-1/2'>
      <h1 className='text-9xl uppercase pt-24'>presentations</h1>
      <div className='flex'>
        <div className='w-1/2 flex flex-col pt-8 '>
            ...
            <a>Facebook</a>
            <a>LinkedIn</a>
            <a className='pt-10'>L:</a>
            <a>202-1965 W 4th Ave</a>
            <a>Vancouver, Canada</a>
            <a>30 Chukarina St</a>
            <a>Lviv, Ukraine</a>
            <a className='pt-10'>E:</a>
            <a>hello@ochi.design</a>
            </div>
            <div className='w-1/2 flex flex-col pt-48 pl-40'>
            <a>M:</a>
            <a>Home</a>
            <a>Services</a>
            <a>Our Work</a>
